...
public class CustomerOrderDetailControllerTest {
    ...
    void givenRequest_whenGetResponse_ItShouldReturnStatusOk() throws Exception {
        ...
        orderBookDetails[1] = new OrderBookDetailDTO(1, 1, 6000.0, "aaaa", "5234543212", "123456", "aaaa", "aaaaaaaa", "aaaaa", "aaaaaa", "aaaa");
        orderBookDetails[1] = new OrderBookDetailDTO(3, 1, 6000.0, "aaaa", "5234543212", "123456", "aaaa", "aaaaaaaa", "aaaaa", "aaaaaa", "aaaa");
